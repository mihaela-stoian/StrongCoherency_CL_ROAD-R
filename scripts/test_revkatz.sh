...
EXP_NAME="resnet50I3D512-Pkinetics-b8s8x1x1-roadt1-h3x3x3-rev-katzc10.000000-03-22-11-48-08x"

# CHECK ALL PARAMETERS!!!!!!!!

cd ..
CUDA_VISIBLE_DEVICES=0 NCCL_DEBUG="INFO" python main.py $DATASET $DATASET $KINETICS --MODE=gen_dets --ARCH=resnet50 --MODEL_TYPE=I3D --DATASET=road --TRAIN_SUBSETS=train_1 --VAL_SUBSETS=val_1 --SEQ_LEN=8 --TEST_SEQ_LEN=8 --BATCH_SIZE=$BATCH_SIZE --LR=0.0041 --CCN_CONSTRAINTS=$CONSTRAINTS --CCN_CENTRALITY=$CENTRALITY --CCN_NUM_CLASSES=$CCN_NUM_CLASSES --OPTIM=$OPTIM --CLIP=$CLIP --EXP_NAME=$EXP_NAME
